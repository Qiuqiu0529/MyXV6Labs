...
int Process(int readin, int writeout)
{
  ...
  16:	3b8080e7          	jalr	952(ra) # 3ca <fork>
  1a:	892a                	mv	s2,a0
  if (pid == 0)
  1c:	e55d                	bnez	a0,ca <Process+0xca>
  {
    close(writeout);
  1e:	854e                	mv	a0,s3
  20:	00000097          	auipc	ra,0x0
  24:	3da080e7          	jalr	986(ra) # 3fa <close>
    int prime, number;
    read(readin, &prime, sizeof(int));
  28:	4611                	li	a2,4
  2a:	fc040593          	addi	a1,s0,-64
  2e:	8526                	mv	a0,s1
  30:	00000097          	auipc	ra,0x0
  34:	3ba080e7          	jalr	954(ra) # 3ea <read>
    printf("prime %d\n", prime);
  38:	fc042583          	lw	a1,-64(s0)
  3c:	00001517          	auipc	a0,0x1
  40:	8b450513          	addi	a0,a0,-1868 # 8f0 <malloc+0xe8>
  44:	00000097          	auipc	ra,0x0
  48:	706080e7          	jalr	1798(ra) # 74a <printf>
    {
      ...
      {
        if (number >= MAX)
  4c:	02200993          	li	s3,34
    while (read(readin, &number, sizeof(int)) > 0)
  50:	4611                	li	a2,4
  52:	fc440593          	addi	a1,s0,-60
  56:	8526                	mv	a0,s1
  58:	00000097          	auipc	ra,0x0
  5c:	392080e7          	jalr	914(ra) # 3ea <read>
  60:	04a05763          	blez	a0,ae <Process+0xae>
      if (number % prime != 0) //      
  64:	fc442703          	lw	a4,-60(s0)
  68:	fc042783          	lw	a5,-64(s0)
  6c:	02f767bb          	remw	a5,a4,a5
  70:	d3e5                	beqz	a5,50 <Process+0x50>
        if (number >= MAX)
  72:	02e9ce63          	blt	s3,a4,ae <Process+0xae>
            break;
        if (pid == 0)
  76:	00090c63          	beqz	s2,8e <Process+0x8e>
        {
          pipe(p2);
  ...
  7a:	4611                	li	a2,4
  7c:	fc440593          	addi	a1,s0,-60
  80:	fcc42503          	lw	a0,-52(s0)
  84:	00000097          	auipc	ra,0x0
  88:	36e080e7          	jalr	878(ra) # 3f2 <write>
  8c:	b7d1                	j	50 <Process+0x50>
          pipe(p2);
  8e:	fc840513          	addi	a0,s0,-56
  92:	00000097          	auipc	ra,0x0
  96:	350080e7          	jalr	848(ra) # 3e2 <pipe>
          pid = Process(p2[0], p2[1]);
  9a:	fcc42583          	lw	a1,-52(s0)
  9e:	fc842503          	lw	a0,-56(s0)
  a2:	00000097          	auipc	ra,0x0
  a6:	f5e080e7          	jalr	-162(ra) # 0 <Process>
  aa:	892a                	mv	s2,a0
  ac:	b7f9                	j	7a <Process+0x7a>
      }
    }
    close(p2[1]);
  ae:	fcc42503          	lw	a0,-52(s0)
  b2:	00000097          	auipc	ra,0x0
  b6:	348080e7          	jalr	840(ra) # 3fa <close>
    if (pid > 0)
  ba:	01205d63          	blez	s2,d4 <Process+0xd4>
      wait(0);  
  be:	4501                	li	a0,0
  c0:	00000097          	auipc	ra,0x0
  c4:	31a080e7          	jalr	794(ra) # 3da <wait>
  c8:	a031                	j	d4 <Process+0xd4>
  }
  else
  {
    close(readin);
  ...
  d0:	32e080e7          	jalr	814(ra) # 3fa <close>
  }
  return pid; 
}
  d4:	854a                	mv	a0,s2
...
int main(int argc, char *argv[])
{
  ...
  f6:	2f0080e7          	jalr	752(ra) # 3e2 <pipe>
  if (Process(p1[0], p1[1]) > 0)
  fa:	fdc42583          	lw	a1,-36(s0)
  fe:	fd842503          	lw	a0,-40(s0)
 102:	00000097          	auipc	ra,0x0
 106:	efe080e7          	jalr	-258(ra) # 0 <Process>
 10a:	04a05463          	blez	a0,152 <main+0x6e>
  {
    for (int i = 2; i <= MAX; i++)
 10e:	4789                	li	a5,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ba:	45250513          	addi	a0,a0,1106 # 908 <digits>
 4be:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 586:	386b8b93          	addi	s7,s7,902 # 908 <digits>
 ...
 6c6:	23e90913          	addi	s2,s2,574 # 900 <malloc+0xf8>
        while(*s != 0){
...
free(void *ap)
{
 ...
 78e:	1967b783          	ld	a5,406(a5) # 920 <freep>
 ...
 7bc:	00e6ea63          	bltu	a3,a4,7d0 <free+0x50>
{
 ...
 7fe:	12f73323          	sd	a5,294(a4) # 920 <freep>
}
 802:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 830:	0f453503          	ld	a0,244(a0) # 920 <freep>
 ...
 858:	0cc90913          	addi	s2,s2,204 # 920 <freep>
  if(p == (char*)-1)
 85c:	5afd                	li	s5,-1
 85e:	a88d                	j	8d0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 860:	00000797          	auipc	a5,0x0
 864:	0c878793          	addi	a5,a5,200 # 928 <base>
 868:	00000717          	auipc	a4,0x0
 86c:	0af73c23          	sd	a5,184(a4) # 920 <freep>
 870:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 892:	08a73923          	sd	a0,146(a4) # 920 <freep>
      return (void*)(p + 1);
