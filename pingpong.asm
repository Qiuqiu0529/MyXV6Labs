...
int main(int argc, char *argv[])
{
  ...
  8a:	89a50513          	addi	a0,a0,-1894 # 920 <malloc+0xf8>
  ...
  b2:	88a50513          	addi	a0,a0,-1910 # 938 <malloc+0x110>
 ...
 106:	83650513          	addi	a0,a0,-1994 # 938 <malloc+0x110>
 ...
 138:	7dc50513          	addi	a0,a0,2012 # 910 <malloc+0xe8>
 ...
 15c:	7f050513          	addi	a0,a0,2032 # 948 <malloc+0x120>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4da:	49250513          	addi	a0,a0,1170 # 968 <digits>
 4de:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5a6:	3c6b8b93          	addi	s7,s7,966 # 968 <digits>
 ...
 6e6:	27e90913          	addi	s2,s2,638 # 960 <malloc+0x138>
        while(*s != 0){
...
free(void *ap)
{
 ...
 7ae:	1d67b783          	ld	a5,470(a5) # 980 <freep>
 ...
 7dc:	00e6ea63          	bltu	a3,a4,7f0 <free+0x50>
{
 ...
 81e:	16f73323          	sd	a5,358(a4) # 980 <freep>
}
 822:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 850:	13453503          	ld	a0,308(a0) # 980 <freep>
 ...
 878:	10c90913          	addi	s2,s2,268 # 980 <freep>
  if(p == (char*)-1)
 87c:	5afd                	li	s5,-1
 87e:	a88d                	j	8f0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 880:	00000797          	auipc	a5,0x0
 884:	10878793          	addi	a5,a5,264 # 988 <base>
 888:	00000717          	auipc	a4,0x0
 88c:	0ef73c23          	sd	a5,248(a4) # 980 <freep>
 890:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8b2:	0ca73923          	sd	a0,210(a4) # 980 <freep>
      return (void*)(p + 1);
