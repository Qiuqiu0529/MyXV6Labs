...
int main(int argc, char *argv[])
{
  ...
  40:	7d450513          	addi	a0,a0,2004 # 810 <malloc+0x10e>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b4:	49050513          	addi	a0,a0,1168 # 840 <digits>
 3b8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 480:	3c4b8b93          	addi	s7,s7,964 # 840 <digits>
 ...
 5c0:	27c90913          	addi	s2,s2,636 # 838 <malloc+0x136>
        while(*s != 0){
...
free(void *ap)
{
 ...
 688:	1d47b783          	ld	a5,468(a5) # 858 <freep>
 ...
 6b6:	00e6ea63          	bltu	a3,a4,6ca <free+0x50>
{
 ...
 6f8:	16f73223          	sd	a5,356(a4) # 858 <freep>
}
 6fc:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 72a:	13253503          	ld	a0,306(a0) # 858 <freep>
 ...
 752:	10a90913          	addi	s2,s2,266 # 858 <freep>
  if(p == (char*)-1)
 756:	5afd                	li	s5,-1
 758:	a88d                	j	7ca <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 75a:	00000797          	auipc	a5,0x0
 75e:	10678793          	addi	a5,a5,262 # 860 <base>
 762:	00000717          	auipc	a4,0x0
 766:	0ef73b23          	sd	a5,246(a4) # 858 <freep>
 76a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 78c:	0ca73823          	sd	a0,208(a4) # 858 <freep>
      return (void*)(p + 1);
