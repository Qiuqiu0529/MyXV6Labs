    ...
    8000085a:	08f70263          	beq	a4,a5,800008de <uartstart+0x94>
{
    ...
    800008ba:	b3e080e7          	jalr	-1218(ra) # 800023f4 <wakeup>
...
00000000800008e0 <uartputc>:
{
  ...
  if(panicked){
    ...
    80000954:	91e080e7          	jalr	-1762(ra) # 8000226e <sleep>
    if(((uart_tx_w + 1) % UART_TX_BUF_SIZE) == uart_tx_r){
...
countfreemem(void) // for counting free memory
{
  ...
  acquire(&kmem.lock); // in case of race condition
    80000a2e:	00011497          	auipc	s1,0x11
    80000a32:	f0248493          	addi	s1,s1,-254 # 80011930 <kmem>
    80000a36:	8526                	mv	a0,s1
    80000a38:	00000097          	auipc	ra,0x0
    80000a3c:	222080e7          	jalr	546(ra) # 80000c5a <acquire>
  uint64 mem_bytes = 0;
  struct run *r = kmem.freelist;
    80000a40:	6c9c                	ld	a5,24(s1)
  while(r)
    80000a42:	c785                	beqz	a5,80000a6a <countfreemem+0x46>
  uint64 mem_bytes = 0;
    80000a44:	4481                	li	s1,0
  {
    mem_bytes += PGSIZE;
    80000a46:	6705                	lui	a4,0x1
    80000a48:	94ba                	add	s1,s1,a4
    r = r->next;
    80000a4a:	639c                	ld	a5,0(a5)
  while(r)
    80000a4c:	fff5                	bnez	a5,80000a48 <countfreemem+0x24>
  }

  release(&kmem.lock);
    80000a4e:	00011517          	auipc	a0,0x11
    80000a52:	ee250513          	addi	a0,a0,-286 # 80011930 <kmem>
    80000a56:	00000097          	auipc	ra,0x0
    80000a5a:	2b8080e7          	jalr	696(ra) # 80000d0e <release>
  return mem_bytes;
}
    ...
    80000a68:	8082                	ret
  uint64 mem_bytes = 0;
    80000a6a:	4481                	li	s1,0
    80000a6c:	b7cd                	j	80000a4e <countfreemem+0x2a>
...
kfree(void *pa)
{
  ...
  if(((uint64)pa % PGSIZE) != 0 || (char*)pa < end || (uint64)pa >= PHYSTOP)
    ...
    80000a82:	00025797          	auipc	a5,0x25
    80000a86:	57e78793          	addi	a5,a5,1406 # 80026000 <end>
  ...
  release(&kmem.lock);
    ...
    80000ad8:	58c50513          	addi	a0,a0,1420 # 80008060 <digits+0x20>
    80000adc:	00000097          	auipc	ra,0x0
    80000ae0:	a6c080e7          	jalr	-1428(ra) # 80000548 <panic>
...
0000000080000b2e <kinit>:
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    80000b3a:	53258593          	addi	a1,a1,1330 # 80008068 <digits+0x28>
  ...
  freerange(end, (void*)PHYSTOP);
    ...
    80000b52:	00025517          	auipc	a0,0x25
    80000b56:	4ae50513          	addi	a0,a0,1198 # 80026000 <end>
...
main()
{
  ...
  scheduler();        
    ...
    80000f62:	034080e7          	jalr	52(ra) # 80001f92 <scheduler>
    consoleinit();
    ...
    80000faa:	b88080e7          	jalr	-1144(ra) # 80000b2e <kinit>
    ...
    8000100a:	d1e080e7          	jalr	-738(ra) # 80001d24 <userinit>
    __sync_synchronize();
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  if(va >= MAXVA)
    ...
    80001080:	aee080e7          	jalr	-1298(ra) # 80000b6a <kalloc>
...
000000008000124e <kvminit>:
{
  ...
  kernel_pagetable = (pagetable_t) kalloc();
    ...
    8000125c:	912080e7          	jalr	-1774(ra) # 80000b6a <kalloc>
...
uvmunmap(pagetable_t pagetable, uint64 va, uint64 npages, int do_free)
{
  ...
  for(a = va; a < va + npages*PGSIZE; a += PGSIZE){
    ...
    *pte = 0;
    ...
    800013ae:	6c4080e7          	jalr	1732(ra) # 80000a6e <kfree>
    *pte = 0;
...
uvmcreate()
{
  ...
  pagetable = (pagetable_t) kalloc();
    ...
    800013f2:	77c080e7          	jalr	1916(ra) # 80000b6a <kalloc>
...
uvminit(pagetable_t pagetable, uchar *src, uint sz)
{
  ...
  mem = kalloc();
    ...
    80001432:	73c080e7          	jalr	1852(ra) # 80000b6a <kalloc>
    ...
    800014cc:	0ab66163          	bltu	a2,a1,8000156e <uvmalloc+0xa2>
{
  ...
  for(a = oldsz; a < newsz; a += PGSIZE){
    ...
    800014fc:	672080e7          	jalr	1650(ra) # 80000b6a <kalloc>
  ...
  return newsz;
    ...
    80001558:	51a080e7          	jalr	1306(ra) # 80000a6e <kfree>
      uvmdealloc(pagetable, a, oldsz);
    ...
    80001618:	c679                	beqz	a2,800016e6 <uvmcopy+0xce>
{
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80001660:	50e080e7          	jalr	1294(ra) # 80000b6a <kalloc>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    800016b8:	3ba080e7          	jalr	954(ra) # 80000a6e <kfree>
    }
  }
  return 0;
...
000000008000192c <procinit>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001994:	1da080e7          	jalr	474(ra) # 80000b6a <kalloc>
...
0000000080001a60 <forkret>:
{
  ...
  if (first) {
    ...
    80001a7c:	e687a783          	lw	a5,-408(a5) # 800088e0 <first.1675>
  ...
  usertrapret();
    ...
    80001a96:	e407a723          	sw	zero,-434(a5) # 800088e0 <first.1675>
    fsinit(ROOTDEV);
...
0000000080001aec <countprocess>:
{ 
    80001aec:	1141                	addi	sp,sp,-16
    80001aee:	e422                	sd	s0,8(sp)
    80001af0:	0800                	addi	s0,sp,16
  for(struct proc *p = proc; p < &proc[NPROC]; p++) 
    80001af2:	00010797          	auipc	a5,0x10
    80001af6:	27678793          	addi	a5,a5,630 # 80011d68 <proc>
  uint64 n = 0;
    80001afa:	4501                	li	a0,0
  for(struct proc *p = proc; p < &proc[NPROC]; p++) 
    80001afc:	00016697          	auipc	a3,0x16
    80001b00:	e6c68693          	addi	a3,a3,-404 # 80017968 <tickslock>
    if(p->state != UNUSED) 
    80001b04:	4f98                	lw	a4,24(a5)
        n++;
    80001b06:	00e03733          	snez	a4,a4
    80001b0a:	953a                	add	a0,a0,a4
  for(struct proc *p = proc; p < &proc[NPROC]; p++) 
    80001b0c:	17078793          	addi	a5,a5,368
    80001b10:	fed79ae3          	bne	a5,a3,80001b04 <countprocess+0x18>
}
    80001b14:	6422                	ld	s0,8(sp)
    80001b16:	0141                	addi	sp,sp,16
    80001b18:	8082                	ret

0000000080001b1a <proc_pagetable>:
{
  ...
  pagetable = uvmcreate();
    ...
    80001b2c:	8bc080e7          	jalr	-1860(ra) # 800013e4 <uvmcreate>
    80001b30:	84aa                	mv	s1,a0
  if(pagetable == 0)
    80001b32:	c121                	beqz	a0,80001b72 <proc_pagetable+0x58>
  if(mappages(pagetable, TRAMPOLINE, PGSIZE,
    ...
    80001b4c:	640080e7          	jalr	1600(ra) # 80001188 <mappages>
    80001b50:	02054863          	bltz	a0,80001b80 <proc_pagetable+0x66>
  if(mappages(pagetable, TRAPFRAME, PGSIZE,
    80001b54:	4719                	li	a4,6
    80001b56:	05893683          	ld	a3,88(s2)
    ...
    80001b6a:	622080e7          	jalr	1570(ra) # 80001188 <mappages>
    80001b6e:	02054163          	bltz	a0,80001b90 <proc_pagetable+0x76>
}
    ...
    80001b88:	a5c080e7          	jalr	-1444(ra) # 800015e0 <uvmfree>
    return 0;
    80001b8c:	4481                	li	s1,0
    80001b8e:	b7d5                	j	80001b72 <proc_pagetable+0x58>
    uvmunmap(pagetable, TRAMPOLINE, 1, 0);
    80001b90:	4681                	li	a3,0
    80001b92:	4605                	li	a2,1
    80001b94:	040005b7          	lui	a1,0x4000
    80001b98:	15fd                	addi	a1,a1,-1
    80001b9a:	05b2                	slli	a1,a1,0xc
    80001b9c:	8526                	mv	a0,s1
    80001b9e:	fffff097          	auipc	ra,0xfffff
    80001ba2:	782080e7          	jalr	1922(ra) # 80001320 <uvmunmap>
    uvmfree(pagetable, 0);
    80001ba6:	4581                	li	a1,0
    80001ba8:	8526                	mv	a0,s1
    80001baa:	00000097          	auipc	ra,0x0
    80001bae:	a36080e7          	jalr	-1482(ra) # 800015e0 <uvmfree>
    return 0;
    80001bb2:	4481                	li	s1,0
    80001bb4:	bf7d                	j	80001b72 <proc_pagetable+0x58>

0000000080001bb6 <proc_freepagetable>:
{
  ...
  uvmunmap(pagetable, TRAMPOLINE, 1, 0);
    ...
    80001bd6:	74e080e7          	jalr	1870(ra) # 80001320 <uvmunmap>
  uvmunmap(pagetable, TRAPFRAME, 1, 0);
    ...
    80001bec:	738080e7          	jalr	1848(ra) # 80001320 <uvmunmap>
  uvmfree(pagetable, sz);
    80001bf0:	85ca                	mv	a1,s2
    80001bf2:	8526                	mv	a0,s1
    80001bf4:	00000097          	auipc	ra,0x0
    80001bf8:	9ec080e7          	jalr	-1556(ra) # 800015e0 <uvmfree>
}
...
0000000080001c08 <freeproc>:
{
  ...
  if(p->trapframe)
    80001c14:	6d28                	ld	a0,88(a0)
    80001c16:	c509                	beqz	a0,80001c20 <freeproc+0x18>
    kfree((void*)p->trapframe);
    80001c18:	fffff097          	auipc	ra,0xfffff
    80001c1c:	e56080e7          	jalr	-426(ra) # 80000a6e <kfree>
  p->trapframe = 0;
    80001c20:	0404bc23          	sd	zero,88(s1)
  if(p->pagetable)
    80001c24:	68a8                	ld	a0,80(s1)
    80001c26:	c511                	beqz	a0,80001c32 <freeproc+0x2a>
    proc_freepagetable(p->pagetable, p->sz);
    80001c28:	64ac                	ld	a1,72(s1)
    80001c2a:	00000097          	auipc	ra,0x0
    80001c2e:	f8c080e7          	jalr	-116(ra) # 80001bb6 <proc_freepagetable>
  p->pagetable = 0;
    80001c32:	0404b823          	sd	zero,80(s1)
  p->sz = 0;
    80001c36:	0404b423          	sd	zero,72(s1)
  p->pid = 0;
    80001c3a:	0204ac23          	sw	zero,56(s1)
  p->parent = 0;
    80001c3e:	0204b023          	sd	zero,32(s1)
  p->name[0] = 0;
    80001c42:	14048c23          	sb	zero,344(s1)
  p->chan = 0;
    80001c46:	0204b423          	sd	zero,40(s1)
  p->killed = 0;
    80001c4a:	0204a823          	sw	zero,48(s1)
  p->xstate = 0;
    80001c4e:	0204aa23          	sw	zero,52(s1)
  p->state = UNUSED;
    80001c52:	0004ac23          	sw	zero,24(s1)
}
...
0000000080001c60 <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    80001c6c:	00010497          	auipc	s1,0x10
    80001c70:	0fc48493          	addi	s1,s1,252 # 80011d68 <proc>
    80001c74:	00016917          	auipc	s2,0x16
    80001c78:	cf490913          	addi	s2,s2,-780 # 80017968 <tickslock>
    acquire(&p->lock);
    80001c7c:	8526                	mv	a0,s1
    80001c7e:	fffff097          	auipc	ra,0xfffff
    80001c82:	fdc080e7          	jalr	-36(ra) # 80000c5a <acquire>
    if(p->state == UNUSED) {
    80001c86:	4c9c                	lw	a5,24(s1)
    80001c88:	cf81                	beqz	a5,80001ca0 <allocproc+0x40>
      release(&p->lock);
    80001c8a:	8526                	mv	a0,s1
    80001c8c:	fffff097          	auipc	ra,0xfffff
    80001c90:	082080e7          	jalr	130(ra) # 80000d0e <release>
  for(p = proc; p < &proc[NPROC]; p++) {
    80001c94:	17048493          	addi	s1,s1,368
    80001c98:	ff2492e3          	bne	s1,s2,80001c7c <allocproc+0x1c>
  return 0;
    80001c9c:	4481                	li	s1,0
    80001c9e:	a889                	j	80001cf0 <allocproc+0x90>
  p->pid = allocpid();
    80001ca0:	00000097          	auipc	ra,0x0
    80001ca4:	e06080e7          	jalr	-506(ra) # 80001aa6 <allocpid>
    80001ca8:	dc88                	sw	a0,56(s1)
  if((p->trapframe = (struct trapframe *)kalloc()) == 0){
    80001caa:	fffff097          	auipc	ra,0xfffff
    80001cae:	ec0080e7          	jalr	-320(ra) # 80000b6a <kalloc>
    80001cb2:	892a                	mv	s2,a0
    80001cb4:	eca8                	sd	a0,88(s1)
    80001cb6:	c521                	beqz	a0,80001cfe <allocproc+0x9e>
  p->pagetable = proc_pagetable(p);
    80001cb8:	8526                	mv	a0,s1
    80001cba:	00000097          	auipc	ra,0x0
    80001cbe:	e60080e7          	jalr	-416(ra) # 80001b1a <proc_pagetable>
    80001cc2:	892a                	mv	s2,a0
    80001cc4:	e8a8                	sd	a0,80(s1)
  if(p->pagetable == 0){
    80001cc6:	c139                	beqz	a0,80001d0c <allocproc+0xac>
  memset(&p->context, 0, sizeof(p->context));
    80001cc8:	07000613          	li	a2,112
    80001ccc:	4581                	li	a1,0
    80001cce:	06048513          	addi	a0,s1,96
    80001cd2:	fffff097          	auipc	ra,0xfffff
    80001cd6:	084080e7          	jalr	132(ra) # 80000d56 <memset>
  p->context.ra = (uint64)forkret;
    80001cda:	00000797          	auipc	a5,0x0
    80001cde:	d8678793          	addi	a5,a5,-634 # 80001a60 <forkret>
  ...
  p->syscall_trace = 0; // syscall_trace init as 0
    80001cec:	1604b423          	sd	zero,360(s1)
}
    ...
    80001d04:	00e080e7          	jalr	14(ra) # 80000d0e <release>
    return 0;
    80001d08:	84ca                	mv	s1,s2
    80001d0a:	b7dd                	j	80001cf0 <allocproc+0x90>
    freeproc(p);
    80001d0c:	8526                	mv	a0,s1
    80001d0e:	00000097          	auipc	ra,0x0
    80001d12:	efa080e7          	jalr	-262(ra) # 80001c08 <freeproc>
    release(&p->lock);
    80001d16:	8526                	mv	a0,s1
    80001d18:	fffff097          	auipc	ra,0xfffff
    80001d1c:	ff6080e7          	jalr	-10(ra) # 80000d0e <release>
    return 0;
    80001d20:	84ca                	mv	s1,s2
    80001d22:	b7f9                	j	80001cf0 <allocproc+0x90>
...
0000000080001d24 <userinit>:
{
  ...
  p = allocproc();
    ...
    80001d32:	f32080e7          	jalr	-206(ra) # 80001c60 <allocproc>
    80001d36:	84aa                	mv	s1,a0
  initproc = p;
    80001d38:	00007797          	auipc	a5,0x7
    80001d3c:	2ea7b023          	sd	a0,736(a5) # 80009018 <initproc>
  uvminit(p->pagetable, initcode, sizeof(initcode));
    80001d40:	03400613          	li	a2,52
    80001d44:	00007597          	auipc	a1,0x7
    80001d48:	bac58593          	addi	a1,a1,-1108 # 800088f0 <initcode>
    80001d4c:	6928                	ld	a0,80(a0)
    80001d4e:	fffff097          	auipc	ra,0xfffff
    80001d52:	6c4080e7          	jalr	1732(ra) # 80001412 <uvminit>
  p->sz = PGSIZE;
    80001d56:	6785                	lui	a5,0x1
    80001d58:	e4bc                	sd	a5,72(s1)
  p->trapframe->epc = 0;      // user program counter
    80001d5a:	6cb8                	ld	a4,88(s1)
    80001d5c:	00073c23          	sd	zero,24(a4) # 1018 <_entry-0x7fffefe8>
  ...
  safestrcpy(p->name, "initcode", sizeof(p->name));
    ...
    80001d6a:	48258593          	addi	a1,a1,1154 # 800081e8 <digits+0x1a8>
    80001d6e:	15848513          	addi	a0,s1,344
    80001d72:	fffff097          	auipc	ra,0xfffff
    80001d76:	13a080e7          	jalr	314(ra) # 80000eac <safestrcpy>
  p->cwd = namei("/");
    80001d7a:	00006517          	auipc	a0,0x6
    80001d7e:	47e50513          	addi	a0,a0,1150 # 800081f8 <digits+0x1b8>
    80001d82:	00002097          	auipc	ra,0x2
    80001d86:	18c080e7          	jalr	396(ra) # 80003f0e <namei>
    80001d8a:	14a4b823          	sd	a0,336(s1)
  p->state = RUNNABLE;
  ...
  release(&p->lock);
    ...
    80001d98:	f7a080e7          	jalr	-134(ra) # 80000d0e <release>
}
...
0000000080001da6 <growproc>:
{
  ...
  struct proc *p = myproc();
    ...
    80001db8:	c74080e7          	jalr	-908(ra) # 80001a28 <myproc>
    80001dbc:	892a                	mv	s2,a0
  sz = p->sz;
    80001dbe:	652c                	ld	a1,72(a0)
    80001dc0:	0005861b          	sext.w	a2,a1
  if(n > 0){
    80001dc4:	00904f63          	bgtz	s1,80001de2 <growproc+0x3c>
  } else if(n < 0){
    80001dc8:	0204cc63          	bltz	s1,80001e00 <growproc+0x5a>
  p->sz = sz;
    80001dcc:	1602                	slli	a2,a2,0x20
    80001dce:	9201                	srli	a2,a2,0x20
    80001dd0:	04c93423          	sd	a2,72(s2)
  return 0;
    ...
    80001df2:	6de080e7          	jalr	1758(ra) # 800014cc <uvmalloc>
    80001df6:	0005061b          	sext.w	a2,a0
    80001dfa:	fa69                	bnez	a2,80001dcc <growproc+0x26>
      return -1;
    80001dfc:	557d                	li	a0,-1
    80001dfe:	bfe1                	j	80001dd6 <growproc+0x30>
    sz = uvmdealloc(p->pagetable, sz, sz + n);
    80001e00:	9e25                	addw	a2,a2,s1
    ...
    80001e10:	678080e7          	jalr	1656(ra) # 80001484 <uvmdealloc>
    80001e14:	0005061b          	sext.w	a2,a0
    80001e18:	bf55                	j	80001dcc <growproc+0x26>

0000000080001e1a <fork>:
{
  ...
  struct proc *p = myproc();
    ...
    80001e2e:	bfe080e7          	jalr	-1026(ra) # 80001a28 <myproc>
    80001e32:	892a                	mv	s2,a0
  if((np = allocproc()) == 0){
    80001e34:	00000097          	auipc	ra,0x0
    80001e38:	e2c080e7          	jalr	-468(ra) # 80001c60 <allocproc>
    80001e3c:	c575                	beqz	a0,80001f28 <fork+0x10e>
  ...
  if(uvmcopy(p->pagetable, np->pagetable, p->sz) < 0){
    ...
    80001e4e:	7ce080e7          	jalr	1998(ra) # 80001618 <uvmcopy>
    80001e52:	04054863          	bltz	a0,80001ea2 <fork+0x88>
  np->sz = p->sz;
    80001e56:	04893783          	ld	a5,72(s2)
    80001e5a:	04f9b423          	sd	a5,72(s3) # 4000048 <_entry-0x7bffffb8>
  np->parent = p;
    80001e5e:	0329b023          	sd	s2,32(s3)
  *(np->trapframe) = *(p->trapframe);
    80001e62:	05893683          	ld	a3,88(s2)
    80001e66:	87b6                	mv	a5,a3
    80001e68:	0589b703          	ld	a4,88(s3)
    80001e6c:	12068693          	addi	a3,a3,288
    80001e70:	0007b803          	ld	a6,0(a5) # 1000 <_entry-0x7ffff000>
    80001e74:	6788                	ld	a0,8(a5)
    80001e76:	6b8c                	ld	a1,16(a5)
    80001e78:	6f90                	ld	a2,24(a5)
    80001e7a:	01073023          	sd	a6,0(a4)
    80001e7e:	e708                	sd	a0,8(a4)
    80001e80:	eb0c                	sd	a1,16(a4)
    80001e82:	ef10                	sd	a2,24(a4)
    80001e84:	02078793          	addi	a5,a5,32
    80001e88:	02070713          	addi	a4,a4,32
    80001e8c:	fed792e3          	bne	a5,a3,80001e70 <fork+0x56>
  np->trapframe->a0 = 0;
    80001e90:	0589b783          	ld	a5,88(s3)
    80001e94:	0607b823          	sd	zero,112(a5)
    80001e98:	0d000493          	li	s1,208
  for(i = 0; i < NOFILE; i++)
    80001e9c:	15000a13          	li	s4,336
    80001ea0:	a03d                	j	80001ece <fork+0xb4>
    freeproc(np);
    80001ea2:	854e                	mv	a0,s3
    80001ea4:	00000097          	auipc	ra,0x0
    80001ea8:	d64080e7          	jalr	-668(ra) # 80001c08 <freeproc>
    release(&np->lock);
    80001eac:	854e                	mv	a0,s3
    80001eae:	fffff097          	auipc	ra,0xfffff
    80001eb2:	e60080e7          	jalr	-416(ra) # 80000d0e <release>
    return -1;
    80001eb6:	54fd                	li	s1,-1
    80001eb8:	a8b9                	j	80001f16 <fork+0xfc>
      np->ofile[i] = filedup(p->ofile[i]);
    80001eba:	00002097          	auipc	ra,0x2
    80001ebe:	6e0080e7          	jalr	1760(ra) # 8000459a <filedup>
    80001ec2:	009987b3          	add	a5,s3,s1
    80001ec6:	e388                	sd	a0,0(a5)
  for(i = 0; i < NOFILE; i++)
    80001ec8:	04a1                	addi	s1,s1,8
    80001eca:	01448763          	beq	s1,s4,80001ed8 <fork+0xbe>
    if(p->ofile[i])
    80001ece:	009907b3          	add	a5,s2,s1
    80001ed2:	6388                	ld	a0,0(a5)
    80001ed4:	f17d                	bnez	a0,80001eba <fork+0xa0>
    80001ed6:	bfcd                	j	80001ec8 <fork+0xae>
  np->cwd = idup(p->cwd);
    80001ed8:	15093503          	ld	a0,336(s2)
    80001edc:	00002097          	auipc	ra,0x2
    80001ee0:	844080e7          	jalr	-1980(ra) # 80003720 <idup>
    80001ee4:	14a9b823          	sd	a0,336(s3)
  safestrcpy(np->name, p->name, sizeof(p->name));
    80001ee8:	4641                	li	a2,16
    80001eea:	15890593          	addi	a1,s2,344
    80001eee:	15898513          	addi	a0,s3,344
    80001ef2:	fffff097          	auipc	ra,0xfffff
    80001ef6:	fba080e7          	jalr	-70(ra) # 80000eac <safestrcpy>
  np->syscall_trace = p->syscall_trace;//inherit
    80001efa:	16893783          	ld	a5,360(s2)
    80001efe:	16f9b423          	sd	a5,360(s3)
  pid = np->pid;
  ...
  release(&np->lock);
    ...
    80001f12:	e00080e7          	jalr	-512(ra) # 80000d0e <release>
}
    ...
    80001f2a:	b7f5                	j	80001f16 <fork+0xfc>
...
0000000080001f2c <reparent>:
{
  ...
  for(pp = proc; pp < &proc[NPROC]; pp++){
    80001f4e:	00016997          	auipc	s3,0x16
    80001f52:	a1a98993          	addi	s3,s3,-1510 # 80017968 <tickslock>
    80001f56:	a029                	j	80001f60 <reparent+0x34>
    80001f58:	17048493          	addi	s1,s1,368
    ...
    80001f6c:	cf2080e7          	jalr	-782(ra) # 80000c5a <acquire>
      pp->parent = initproc;
    ...
    80001f7c:	d96080e7          	jalr	-618(ra) # 80000d0e <release>
...
0000000080001f92 <scheduler>:
{
  ...
  c->proc = 0;
    ...
    80001fdc:	99098993          	addi	s3,s3,-1648 # 80017968 <tickslock>
        found = 1;
    ...
    80002006:	d0c080e7          	jalr	-756(ra) # 80000d0e <release>
    for(p = proc; p < &proc[NPROC]; p++) {
    8000200a:	17048493          	addi	s1,s1,368
    8000200e:	01348b63          	beq	s1,s3,80002024 <scheduler+0x92>
      acquire(&p->lock);
    80002012:	8526                	mv	a0,s1
    80002014:	fffff097          	auipc	ra,0xfffff
    80002018:	c46080e7          	jalr	-954(ra) # 80000c5a <acquire>
      if(p->state == RUNNABLE) {
...
0000000080002052 <sched>:
{
  ...
  struct proc *p = myproc();
    ...
    80002064:	9c8080e7          	jalr	-1592(ra) # 80001a28 <myproc>
    80002068:	84aa                	mv	s1,a0
  if(!holding(&p->lock))
    8000206a:	fffff097          	auipc	ra,0xfffff
    8000206e:	b76080e7          	jalr	-1162(ra) # 80000be0 <holding>
...
0000000080002128 <exit>:
{
  ...
  struct proc *p = myproc();
    ...
    8000213e:	8ee080e7          	jalr	-1810(ra) # 80001a28 <myproc>
  ...
  if(p == initproc)
    ...
    8000216c:	484080e7          	jalr	1156(ra) # 800045ec <fileclose>
      p->ofile[fd] = 0;
  ...
  begin_op();
    ...
    80002184:	f9a080e7          	jalr	-102(ra) # 8000411a <begin_op>
  iput(p->cwd);
    80002188:	1509b503          	ld	a0,336(s3)
    8000218c:	00001097          	auipc	ra,0x1
    80002190:	78c080e7          	jalr	1932(ra) # 80003918 <iput>
  end_op();
    80002194:	00002097          	auipc	ra,0x2
    80002198:	006080e7          	jalr	6(ra) # 8000419a <end_op>
  p->cwd = 0;
  ...
  acquire(&initproc->lock);
    ...
    800021ae:	ab0080e7          	jalr	-1360(ra) # 80000c5a <acquire>
  wakeup1(initproc);
    800021b2:	6088                	ld	a0,0(s1)
    800021b4:	fffff097          	auipc	ra,0xfffff
    800021b8:	734080e7          	jalr	1844(ra) # 800018e8 <wakeup1>
  release(&initproc->lock);
    800021bc:	6088                	ld	a0,0(s1)
    800021be:	fffff097          	auipc	ra,0xfffff
    800021c2:	b50080e7          	jalr	-1200(ra) # 80000d0e <release>
  acquire(&p->lock);
    800021c6:	854e                	mv	a0,s3
    800021c8:	fffff097          	auipc	ra,0xfffff
    800021cc:	a92080e7          	jalr	-1390(ra) # 80000c5a <acquire>
  struct proc *original_parent = p->parent;
    800021d0:	0209b483          	ld	s1,32(s3)
  release(&p->lock);
    800021d4:	854e                	mv	a0,s3
    800021d6:	fffff097          	auipc	ra,0xfffff
    800021da:	b38080e7          	jalr	-1224(ra) # 80000d0e <release>
  acquire(&original_parent->lock);
    800021de:	8526                	mv	a0,s1
    800021e0:	fffff097          	auipc	ra,0xfffff
    800021e4:	a7a080e7          	jalr	-1414(ra) # 80000c5a <acquire>
  acquire(&p->lock);
    800021e8:	854e                	mv	a0,s3
    800021ea:	fffff097          	auipc	ra,0xfffff
    800021ee:	a70080e7          	jalr	-1424(ra) # 80000c5a <acquire>
  reparent(p);
  ...
  wakeup1(original_parent);
    ...
    80002202:	6ea080e7          	jalr	1770(ra) # 800018e8 <wakeup1>
  p->xstate = status;
...
0000000080002232 <yield>:
{
  ...
  struct proc *p = myproc();
    ...
    80002240:	7ec080e7          	jalr	2028(ra) # 80001a28 <myproc>
    80002244:	84aa                	mv	s1,a0
  acquire(&p->lock);
    80002246:	fffff097          	auipc	ra,0xfffff
    8000224a:	a14080e7          	jalr	-1516(ra) # 80000c5a <acquire>
  p->state = RUNNABLE;
  ...
  release(&p->lock);
    ...
    80002260:	ab2080e7          	jalr	-1358(ra) # 80000d0e <release>
}
...
000000008000226e <sleep>:
{
  ...
  struct proc *p = myproc();
    ...
    80002284:	7a8080e7          	jalr	1960(ra) # 80001a28 <myproc>
  ...
  if(lk != &p->lock){  //DOC: sleeplock0
    ...
    8000229c:	a76080e7          	jalr	-1418(ra) # 80000d0e <release>
  p->chan = chan;
  ...
  p->chan = 0;
    ...
    800022ba:	a58080e7          	jalr	-1448(ra) # 80000d0e <release>
    acquire(lk);
    800022be:	854a                	mv	a0,s2
    800022c0:	fffff097          	auipc	ra,0xfffff
    800022c4:	99a080e7          	jalr	-1638(ra) # 80000c5a <acquire>
}
...
00000000800022ec <wait>:
{
  ...
  struct proc *p = myproc();
    ...
    8000230a:	722080e7          	jalr	1826(ra) # 80001a28 <myproc>
    8000230e:	892a                	mv	s2,a0
  acquire(&p->lock);
    80002310:	8c2a                	mv	s8,a0
    80002312:	fffff097          	auipc	ra,0xfffff
    80002316:	948080e7          	jalr	-1720(ra) # 80000c5a <acquire>
    havekids = 0;
    ...
    80002322:	64a98993          	addi	s3,s3,1610 # 80017968 <tickslock>
        havekids = 1;
    ...
    8000234c:	3d4080e7          	jalr	980(ra) # 8000171c <copyout>
    80002350:	02054263          	bltz	a0,80002374 <wait+0x88>
          freeproc(np);
    80002354:	8526                	mv	a0,s1
    80002356:	00000097          	auipc	ra,0x0
    8000235a:	8b2080e7          	jalr	-1870(ra) # 80001c08 <freeproc>
          release(&np->lock);
    8000235e:	8526                	mv	a0,s1
    80002360:	fffff097          	auipc	ra,0xfffff
    80002364:	9ae080e7          	jalr	-1618(ra) # 80000d0e <release>
          release(&p->lock);
    80002368:	854a                	mv	a0,s2
    8000236a:	fffff097          	auipc	ra,0xfffff
    8000236e:	9a4080e7          	jalr	-1628(ra) # 80000d0e <release>
          return pid;
    80002372:	a8a9                	j	800023cc <wait+0xe0>
            release(&np->lock);
    80002374:	8526                	mv	a0,s1
    80002376:	fffff097          	auipc	ra,0xfffff
    8000237a:	998080e7          	jalr	-1640(ra) # 80000d0e <release>
            release(&p->lock);
    8000237e:	854a                	mv	a0,s2
    80002380:	fffff097          	auipc	ra,0xfffff
    80002384:	98e080e7          	jalr	-1650(ra) # 80000d0e <release>
            return -1;
    80002388:	59fd                	li	s3,-1
    8000238a:	a089                	j	800023cc <wait+0xe0>
    for(np = proc; np < &proc[NPROC]; np++){
    8000238c:	17048493          	addi	s1,s1,368
    ...
    800023a0:	8be080e7          	jalr	-1858(ra) # 80000c5a <acquire>
        if(np->state == ZOMBIE){
    ...
    800023b0:	962080e7          	jalr	-1694(ra) # 80000d0e <release>
        havekids = 1;
    ...
    800023c6:	94c080e7          	jalr	-1716(ra) # 80000d0e <release>
      return -1;
...
00000000800023f4 <wakeup>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    80002414:	00015917          	auipc	s2,0x15
    80002418:	55490913          	addi	s2,s2,1364 # 80017968 <tickslock>
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000243a:	824080e7          	jalr	-2012(ra) # 80000c5a <acquire>
    if(p->state == SLEEPING && p->chan == chan) {
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    8000247a:	4f298993          	addi	s3,s3,1266 # 80017968 <tickslock>
    acquire(&p->lock);
    8000247e:	8526                	mv	a0,s1
    80002480:	ffffe097          	auipc	ra,0xffffe
    80002484:	7da080e7          	jalr	2010(ra) # 80000c5a <acquire>
    if(p->pid == pid){
    ...
    80002494:	87e080e7          	jalr	-1922(ra) # 80000d0e <release>
  for(p = proc; p < &proc[NPROC]; p++){
  ...
  return -1;
    ...
    800024b6:	85c080e7          	jalr	-1956(ra) # 80000d0e <release>
      return 0;
...
either_copyout(int user_dst, uint64 dst, void *src, uint64 len)
{
  ...
  struct proc *p = myproc();
    ...
    800024ec:	540080e7          	jalr	1344(ra) # 80001a28 <myproc>
  if(user_dst){
    ...
    800024fe:	222080e7          	jalr	546(ra) # 8000171c <copyout>
  } else {
    ...
    8000251e:	89c080e7          	jalr	-1892(ra) # 80000db6 <memmove>
    return 0;
...
either_copyin(void *dst, int user_src, uint64 src, uint64 len)
{
  ...
  struct proc *p = myproc();
    ...
    80002542:	4ea080e7          	jalr	1258(ra) # 80001a28 <myproc>
  if(user_src){
    ...
    80002554:	258080e7          	jalr	600(ra) # 800017a8 <copyin>
  } else {
    ...
    80002574:	846080e7          	jalr	-1978(ra) # 80000db6 <memmove>
    return 0;
...
procdump(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800025b8:	cb498993          	addi	s3,s3,-844 # 80008268 <digits+0x228>
    printf("%d %s %s", p->pid, state, p->name);
    800025bc:	00006a97          	auipc	s5,0x6
    800025c0:	cb4a8a93          	addi	s5,s5,-844 # 80008270 <digits+0x230>
    printf("\n");
    800025c4:	00006a17          	auipc	s4,0x6
    800025c8:	b04a0a13          	addi	s4,s4,-1276 # 800080c8 <digits+0x88>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
    800025cc:	00006b97          	auipc	s7,0x6
    800025d0:	cdcb8b93          	addi	s7,s7,-804 # 800082a8 <states.1715>
    ...
    800025ea:	fac080e7          	jalr	-84(ra) # 80000592 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    800026a0:	c3458593          	addi	a1,a1,-972 # 800082d0 <states.1715+0x28>
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    8000280a:	ad250513          	addi	a0,a0,-1326 # 800082d8 <states.1715+0x30>
...
000000008000285a <usertrap>:
{
  ...
  usertrapret();
    ...
    800028d4:	a2850513          	addi	a0,a0,-1496 # 800082f8 <states.1715+0x50>
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    80002908:	a1450513          	addi	a0,a0,-1516 # 80008318 <states.1715+0x70>
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80002920:	a2c50513          	addi	a0,a0,-1492 # 80008348 <states.1715+0xa0>
  ...
  if(which_dev == 2)
    ...
    80002944:	8f2080e7          	jalr	-1806(ra) # 80002232 <yield>
...
000000008000294e <kerneltrap>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    800029a0:	9cc50513          	addi	a0,a0,-1588 # 80008368 <states.1715+0xc0>
    800029a4:	ffffe097          	auipc	ra,0xffffe
    800029a8:	ba4080e7          	jalr	-1116(ra) # 80000548 <panic>
    panic("kerneltrap: interrupts enabled");
    800029ac:	00006517          	auipc	a0,0x6
    800029b0:	9e450513          	addi	a0,a0,-1564 # 80008390 <states.1715+0xe8>
    ...
    800029c2:	9f250513          	addi	a0,a0,-1550 # 800083b0 <states.1715+0x108>
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    800029da:	9ea50513          	addi	a0,a0,-1558 # 800083c0 <states.1715+0x118>
    800029de:	ffffe097          	auipc	ra,0xffffe
    800029e2:	bb4080e7          	jalr	-1100(ra) # 80000592 <printf>
    panic("kerneltrap");
    800029e6:	00006517          	auipc	a0,0x6
    800029ea:	9f250513          	addi	a0,a0,-1550 # 800083d8 <states.1715+0x130>
  ...
  if(which_dev == 2 && myproc() != 0 && myproc()->state == RUNNING)
    ...
    80002a14:	822080e7          	jalr	-2014(ra) # 80002232 <yield>
...
argraw(int n)
{
  ...
  switch (n) {
    ...
    80002a3a:	aa270713          	addi	a4,a4,-1374 # 800084d8 <states.1715+0x230>
  ...
  panic("argraw");
    ...
    80002a76:	97650513          	addi	a0,a0,-1674 # 800083e8 <states.1715+0x140>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    if((p->syscall_trace >> num) & 1) {//if trace exists
    ...
    80002bfa:	7fa50513          	addi	a0,a0,2042 # 800083f0 <states.1715+0x148>
    ...
    80002c14:	7f850513          	addi	a0,a0,2040 # 80008408 <states.1715+0x160>
...
sys_sysinfo(void)
{
  ...
  info.freemem = countfreemem(); // kalloc.c
    ...
    80002c92:	d96080e7          	jalr	-618(ra) # 80000a24 <countfreemem>
    80002c96:	fca43c23          	sd	a0,-40(s0)
  info.nproc = countprocess(); // proc.c
    80002c9a:	fffff097          	auipc	ra,0xfffff
    80002c9e:	e52080e7          	jalr	-430(ra) # 80001aec <countprocess>
...
sys_exit(void)
{
  ...
  exit(n);
    ...
    80002cf0:	43c080e7          	jalr	1084(ra) # 80002128 <exit>
  return 0;  // not reached
...
sys_fork(void)
{
  ...
  return fork();
    ...
    80002d26:	0f8080e7          	jalr	248(ra) # 80001e1a <fork>
}
...
sys_wait(void)
{
  ...
  return wait(p);
    ...
    80002d58:	598080e7          	jalr	1432(ra) # 800022ec <wait>
}
...
sys_sbrk(void)
{
  ...
  if(growproc(n) < 0)
    ...
    80002d96:	014080e7          	jalr	20(ra) # 80001da6 <growproc>
...
sys_sleep(void)
{
  ...
  while(ticks - ticks0 < n){
    ...
    80002e12:	460080e7          	jalr	1120(ra) # 8000226e <sleep>
  while(ticks - ticks0 < n){
...
sys_kill(void)
{
  ...
  return kill(pid);
    ...
    80002e80:	5e2080e7          	jalr	1506(ra) # 8000245e <kill>
}
    ...
    80003a14:	0ed7e863          	bltu	a5,a3,80003b04 <readi+0xf2>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    ...
    80003a76:	a5e080e7          	jalr	-1442(ra) # 800024d0 <either_copyout>
    ...
    80003b0a:	10d7e663          	bltu	a5,a3,80003c16 <writei+0x10e>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    ...
    80003b6c:	9be080e7          	jalr	-1602(ra) # 80002526 <either_copyin>
...
begin_op(void)
{
  ...
  while(1){
    ...
    8000414a:	128080e7          	jalr	296(ra) # 8000226e <sleep>
    if(log.committing){
    ...
    80004176:	0fc080e7          	jalr	252(ra) # 8000226e <sleep>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    80004208:	1f0080e7          	jalr	496(ra) # 800023f4 <wakeup>
    release(&log.lock);
    ...
    80004246:	1b2080e7          	jalr	434(ra) # 800023f4 <wakeup>
  release(&log.lock);
...
acquiresleep(struct sleeplock *lk)
{
  ...
  while (lk->locked) {
    ...
    80004440:	e32080e7          	jalr	-462(ra) # 8000226e <sleep>
  while (lk->locked) {
...
releasesleep(struct sleeplock *lk)
{
  ...
  wakeup(lk);
    ...
    80004498:	f60080e7          	jalr	-160(ra) # 800023f4 <wakeup>
  release(&lk->lk);
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  if((pi = (struct pipe*)kalloc()) == 0)
    ...
    8000497c:	1f2080e7          	jalr	498(ra) # 80000b6a <kalloc>
  ...
  initlock(&pi->lock, "pipe");
    ...
    8000499a:	aaa58593          	addi	a1,a1,-1366 # 80008440 <states.1715+0x198>
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  if(writable){
    ...
    80004a44:	9b4080e7          	jalr	-1612(ra) # 800023f4 <wakeup>
  } else {
    pi->readopen = 0;
    wakeup(&pi->nwrite);
  }
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    80004a5e:	014080e7          	jalr	20(ra) # 80000a6e <kfree>
  } else
    release(&pi->lock);
}
    ...
    80004a7a:	97e080e7          	jalr	-1666(ra) # 800023f4 <wakeup>
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  for(i = 0; i < n; i++){
    ...
    80004b06:	8f2080e7          	jalr	-1806(ra) # 800023f4 <wakeup>
      sleep(&pi->nwrite, &pi->lock);
    80004b0a:	85ce                	mv	a1,s3
    80004b0c:	8552                	mv	a0,s4
    80004b0e:	ffffd097          	auipc	ra,0xffffd
    80004b12:	760080e7          	jalr	1888(ra) # 8000226e <sleep>
    while(pi->nwrite == pi->nread + PIPESIZE){  //DOC: pipewrite-full
  ...
  wakeup(&pi->nread);
    ...
    80004ba0:	858080e7          	jalr	-1960(ra) # 800023f4 <wakeup>
  release(&pi->lock);
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    ...
    80004c04:	66e080e7          	jalr	1646(ra) # 8000226e <sleep>
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
  ...
  wakeup(&pi->nwrite);  //DOC: piperead-wakeup
    ...
    80004c66:	792080e7          	jalr	1938(ra) # 800023f4 <wakeup>
  release(&pi->lock);
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  if((pagetable = proc_pagetable(p)) == 0)
    ...
    80004d6a:	db4080e7          	jalr	-588(ra) # 80001b1a <proc_pagetable>
  ...
  proc_freepagetable(oldpagetable, oldsz);
    ...
    80004f54:	c66080e7          	jalr	-922(ra) # 80001bb6 <proc_freepagetable>
  return argc; // this ends up in a0, the first argument to main(argc, argv)
    ...
    80004f6c:	c4e080e7          	jalr	-946(ra) # 80001bb6 <proc_freepagetable>
  if(ip){
...
sys_exec(void)
{
  ...
  memset(argv, 0, sizeof(argv));
    ...
    80005ab4:	0ba080e7          	jalr	186(ra) # 80000b6a <kalloc>
 ...
 bad:
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    ...
    80005ae6:	f8c080e7          	jalr	-116(ra) # 80000a6e <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
  ...
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    ...
    80005b1e:	f54080e7          	jalr	-172(ra) # 80000a6e <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
...
free_desc(int i)
{
  ...
  wakeup(&disk.free[0]);
    ...
    80005dfc:	5fc080e7          	jalr	1532(ra) # 800023f4 <wakeup>
}
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  while(1){
    ...
    8000603c:	236080e7          	jalr	566(ra) # 8000226e <sleep>
  for(int i = 0; i < 3; i++){
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    80006180:	0f2080e7          	jalr	242(ra) # 8000226e <sleep>
  while(b->disk == 1) {
...
virtio_disk_intr()
{
  ...
  while((disk.used_idx % NUM) != (disk.used->id % NUM)){
    ...
    80006282:	176080e7          	jalr	374(ra) # 800023f4 <wakeup>
    disk.used_idx = (disk.used_idx + 1) % NUM;
